...
if ! sudo apt install -y python3-pip python3-venv libgl1; then
...
pip3 install flask flask_socketio opencv-python
if [ $? -ne 0 ]; then
...
echo "BallBot Server installation and service started successfully!"
